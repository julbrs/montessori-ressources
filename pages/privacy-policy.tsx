  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-14 mx-auto flex flex-col">
        ...
        <h2 className="text-l font-bold mb-4">Collecte des renseignements personnels</h2>
        <div>
          <br />
        </div>
        <div>
        ...
        <h2 className="text-l font-bold mb-4">Formulaires&nbsp;et interactivité:</h2>
        ...
        <div>Code postal :&nbsp; H2G 2M5</div>
        <div>Courriel :&nbsp; contact@montessori-ressources.net</div>
        <div></div>
        <div></div>
        <div>
          <br />
